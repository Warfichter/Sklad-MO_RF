...
type
  TForm3 = class(TForm)
    ...
    Button1: TButton;
    Button2: TButton;
    ADOQuery1Warehouse_ID: TAutoIncField;
    ADOQuery1Warehouse_Name: TStringField;
    ADOQuery1Location: TStringField;
    ADOQuery1ResponsiblePerson_ID: TIntegerField;
    ADOQuery1kl: TStringField;
    ADOQuery1sn: TStringField;
...
procedure TForm3.Button133Click(Sender: TObject);
begin
...
begin
ADOQuery1.Active :=false;
ADOQuery1.Parameters.ParamByName('phone').Value :='%'+ Edit1.text +'%';
ADOQuery1.Active :=true;
end;
